...
class EthernetLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ethernet_log" do
    assert_difference('EthernetLog.count') do
      post ethernet_logs_url, params: { ethernet_log: { date: @ethernet_log.date, machine_id: @ethernet_log.machine_id, status: @ethernet_log.status, tenant_id: @ethernet_log.tenant_id } }, as: :json
    end
  ...
  test "should update ethernet_log" do
    patch ethernet_log_url(@ethernet_log), params: { ethernet_log: { date: @ethernet_log.date, machine_id: @ethernet_log.machine_id, status: @ethernet_log.status, tenant_id: @ethernet_log.tenant_id } }, as: :json
    assert_response 200
  end
